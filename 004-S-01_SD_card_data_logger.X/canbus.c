...
static sunflare_mppt_t sunflare_mppt[NODE_ID_SUNFLARE_MPPT_TOTAL] = {};
static sls_t sls = {};
...
static void can_bus_receive_messages(void) {
    ...
    if (CAN1_messagesInBuffer() > 0){
        ...
        */
        ...
        // Sunflare MPPT
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x180 && index == 0x2000 && sub_index == 0x01)) {
            // status
            sunflare_mppt[node_id - 0x20].mppt_status = (uint32_t)rx_msg.frame.data7 << 24 | (uint32_t)rx_msg.frame.data6 << 16 | (uint32_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4 ;
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x180 && index == 0x2001 && sub_index == 0x01)) {
            // Solder jumper status
            sunflare_mppt[node_id - 0x20].solder_jumper_status = (uint32_t)rx_msg.frame.data7 << 24 | (uint32_t)rx_msg.frame.data6 << 16 | (uint32_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4 ;
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x280 && index == 0x2000 && sub_index == 0x01)) {
            // Solar input voltage
            sunflare_mppt[node_id - 0x20].solar_input_voltage_in_mv = (uint16_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4;
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x280 && index == 0x2001 && sub_index == 0x01)) {
            // Solar input current
            sunflare_mppt[node_id - 0x20].solar_input_current_in_ma = (uint16_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4;
        }        
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x280 && index == 0x2002 && sub_index == 0x01)) {
            // Current channel 1
            sunflare_mppt[node_id - 0x20].current_channel_1_in_ma = (uint16_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4;
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x280 && index == 0x2003 && sub_index == 0x01)) {
            // Current channel 2
            sunflare_mppt[node_id - 0x20].current_channel_2_in_ma = (uint16_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4;
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x280 && index == 0x2004 && sub_index == 0x01)) {
            // Solar input power
            sunflare_mppt[node_id - 0x20].solar_inpunt_power_in_mw = (uint32_t)rx_msg.frame.data7 << 24 | (uint32_t)rx_msg.frame.data6 << 16 | (uint32_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4 ;
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x280 && index == 0x2005 && sub_index == 0x01)) {
            // Batt output voltage
            sunflare_mppt[node_id - 0x20].batt_output_voltage_in_mv = (uint16_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4;
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x380 && index == 0x2000 && sub_index == 0x01)) {
            // Boost pd error
            sunflare_mppt[node_id - 0x20].boost_pd_error_in_mv = (int16_t)((uint16_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4);
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x380 && index == 0x2001 && sub_index == 0x01)) {
            // Boost pd derivitive
            sunflare_mppt[node_id - 0x20].boost_pd_derivitive_in_mv_dt = (int16_t)((uint16_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4);
        }        
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x380 && index == 0x2002 && sub_index == 0x01)) {
            // Boost pd power change
            sunflare_mppt[node_id - 0x20].boost_power_change_in_mw =(int32_t)((uint32_t)rx_msg.frame.data7 << 24 | (uint32_t)rx_msg.frame.data6 << 16 | (uint32_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4) ;
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x380 && index == 0x2003 && sub_index == 0x01)) {
            // Boost required output power
            sunflare_mppt[node_id - 0x20].boost_req_output_power_in_mw =(uint32_t)rx_msg.frame.data7 << 24 | (uint32_t)rx_msg.frame.data6 << 16 | (uint32_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4 ;
        }        
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x380 && index == 0x2004 && sub_index == 0x01)) {
            // Boost required solar input current
            sunflare_mppt[node_id - 0x20].boost_req_solar_input_in_ma = (uint16_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4;
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x480 && index == 0x2000 && sub_index == 0x01)) {
            // MPPT delta solar power
            sunflare_mppt[node_id - 0x20].mppt_delta_solar_power_in_mw =(int16_t)((uint32_t)rx_msg.frame.data7 << 24 | (uint32_t)rx_msg.frame.data6 << 16 | (uint32_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4) ;
        }        
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x480 && index == 0x2001 && sub_index == 0x01)) {
            // MPPT delta solar input current
            sunflare_mppt[node_id - 0x20].mppt_delta_solar_input_current_in_ma = (int16_t)((uint16_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4);
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x480 && index == 0x2002 && sub_index == 0x01)) {
            // MPPT step change
            sunflare_mppt[node_id - 0x20].mppt_step_change_in_ma = (int16_t)((uint16_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4);
        }
        else if ((NODE_ID_SUNFLARE_MPPT <= node_id && node_id <= (NODE_ID_SUNFLARE_MPPT + NODE_ID_SUNFLARE_MPPT_TOTAL) && function_code == 0x480 && index == 0x2003 && sub_index == 0x01)) {
            // MPPT required solar input current
            sunflare_mppt[node_id - 0x20].mppt_req_solar_input_current_in_ma = (int16_t)((uint16_t)rx_msg.frame.data5 << 8 | (uint16_t)rx_msg.frame.data4);
        }
...
sunflare_mppt_t get_can_data_sunflare_mppt(uint8_t nr) {
    if (nr < NODE_ID_SUNFLARE_MPPT_TOTAL) {
        return sunflare_mppt[nr];
    } else  {
        return sunflare_mppt[0];
    }
}
